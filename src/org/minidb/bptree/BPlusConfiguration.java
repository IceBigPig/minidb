...
public class BPlusConfiguration extends Configuration {
    ...
    public BPlusConfiguration(int pageSize, int valueSize, ArrayList<Type> types, ArrayList<Integer> sizes, ArrayList<Integer> colIDs, boolean unique, int trimFileThreshold) throws MiniDBException {
